...
bingo_nums[12]*sum(input_boards[[3]][which(output_boards[[3]] == 0, arr.ind = T)])
...
bingo_nums[26]*sum(input_boards[[64]][which(output_boards[[64]] == 0, arr.ind = T)])
...
#test
bingo_nums[15]*sum(input_boards[[2]][which(output_boards[[2]] == 0, arr.ind = T)])

#answer
bingo_nums[86]*sum(input_boards[[14]][which(output_boards[[14]] == 0, arr.ind = T)])
